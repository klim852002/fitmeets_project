  ...
  render () {
    return (
      <div className="hold-individual-events-container">
        ...
        <p><i className="fa fa-map-marker maroon"></i> {this.props.event.event_address}   <button id="mapBtn" type="button" className="see-map" data-toggle="modal" data-target="#eventMap">View Map</button> </p>
